...
import { booleanAttribute, Component, DestroyRef, EventEmitter, Inject, inject, Input, OnInit, Output, Pipe, PipeTransform } from '@angular/core';
...
import { AutofocusDirective } from '@widget/directives/autofocus/autofocus.directive';
...
export class DynamicFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.createForm();
    this.form.valueChanges.pipe(debounceTime(500), distinctUntilChanged(), takeUntilDestroyed(this.destroyRef)).subscribe(value => {
